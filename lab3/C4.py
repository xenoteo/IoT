...
def main():
    ...
    def button2_pressed():
        led1.off()
        mqttc.publish("xeno/zone2", "OFF", 0, False)
    ...
    def on_connect(client, userdata, flags, rc):
        ...
        mqttc.publish("xeno/service", "C4 works", 0, True)
    ...
    mqttc = mqtt.Client("copernicus-test-client-4")
    mqttc.on_message = on_message
    mqttc.on_connect = on_connect

    mqttc.connect("test.mosquitto.org", 1883, 60)

    mqttc.will_set("xeno/service", "C4 does not work", 0, True)
